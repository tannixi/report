...
def build_optimizer(args, model):
    ...
    optimizer = getattr(torch.optim, args.optim)(
        [{'params': model.visual_extractor.parameters(), 'lr': float(args.lr_ve)},
         {'params': ed_params, 'lr': float(args.lr_ed)}],
...
def build_lr_scheduler(args, optimizer):
    args.lr_ve=float(args.lr_ve)
    lr_scheduler = getattr(torch.optim.lr_scheduler, args.lr_scheduler)(optimizer, int(args.step_size), float(args.gamma))
    return lr_scheduler
