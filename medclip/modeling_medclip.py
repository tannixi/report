...
#         '''
#         pixel_values = pixel_values.cuda()
#         class_similarities_max = []#存储每个类别的相似度分数
#         class_similarities_max_index = []
#         class_names = [] #类别名称
...
#             logits = medclip_outputs['logits'] #每个文本的得分
#
#             max_values, max_indices = torch.max(logits, dim=1)
#
#             class_similarities_max.append(max_values)
#             class_similarities_max_index.append(max_indices)
#             class_names.append(cls_name)
#         class_similarities_max = torch.stack(class_similarities_max, dim=1)
#         class_similarities_max_index = torch.stack(class_similarities_max_index, dim=1)
#         outputs = {
#             'class_similarities_max': class_similarities_max,
#             'class_similarities_max_index': class_similarities_max_index,
