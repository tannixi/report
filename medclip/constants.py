...
CHEXPERT_CLASS_PROMPTS = {
    ...
    "Consolidation": {
        "severity": ["", "increased", "dimprove", "apperance of"],
        "subtype": [
    ...
    "no Pneumothorax": {
        "severity": ["","No large"],
        "location": [""],
        "subtype": ["No pneumothorax","No visible pneumothorax"],
    },
    "support devices": {
        "severity": ["","stable","standard placements",'remaining',"observed",'medical'],
        "location": [
            "at the lower lung zone",
            "at the upper lung zone",
            "at the left lower lobe",
        ...
        "subtype": ["unchanged support devices",
                    "stable positioning of support devices",
                    "support devices are in appropriate positions",
                    "Cardiopulmonary support devices",
                    "support devices are in a satisfactory position"],
    },

    "Lung Lesion": {
        "severity": ["large cavitary","","suspicious","No suspicious","No focal","focal",'discrete',"one or two",'underlying','intrathoracic'],
        "location": [""],
        "subtype": ["any other lung lesions",'','right lung lesions','left lung lesions'],
    },

    "Lung Opacity": {
        "severity": ["subtle patchy right mid",'subtle patchy left mid','unchanged'],
        "location": ["right lower",'left lower',"right upper","left upper"],
        "subtype": ["lobe Lung Opacity"],
    },
}
