...
from modules1.encoder_decoder import EncoderDecoder
from modules1.visual_extractor import VisualExtractor
...
class XProNet(nn.Module):
    def __init__(self,tokenizer, mode = 'train'):
        ...
        self.encoder_decoder = EncoderDecoder(tokenizer,mode = mode)
